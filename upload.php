...
<body>
	<div id="navbar">
		<div id="navbar-grid-container" class="grid-container">
			<div class="grid-item"><img src="imgs/hamburger.png" id="menu-button"></div>
			<div class="grid-item"><img src="imgs/playline.png" id="navbar-logo"></div>
			<div class="grid-item"><a id="open-login">Log In</a></div>
		</div>
